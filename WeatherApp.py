# Python weather application using Openweathermap API
# Anthony Han 11/19/2023
...
# Note to self: Make sure you are placing the proper label and not another one
...
# Theme for application based off of time
...
def city_name():
    ...
    api_request = requests.get("https://api.openweathermap.org/data/2.5/weather?q="
                                + city_entry.get() + "&units=metric&appid=" + "75e4d62cb53d9ac2d277076451c7eff8")
    ...
    # Add recieved info to the screen
...
min_temp = Label(root, text="Min. Temp: ", width=0,
                       bg='white', font=("bold", 15))
min_temp.place(x=128, y=460)

# Note
note = Label(root, text="All temperatures in degree celsius", width=0,
